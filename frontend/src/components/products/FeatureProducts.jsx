            ...
            <div className="relative overflow-hidden">
              ...
              <ul className="flex flex-col transition-all duration-500 justify-start items-start gap-2 ">
                ...
                <li
                  ...
                  className="w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded shadow hover:bg-orange-500 hover:text-white  absolute -left-10 top-[136px] group-hover:left-5  transition-all duration-700"
                >
                  <FaArrowsSpin />
                </li>
                <Link
