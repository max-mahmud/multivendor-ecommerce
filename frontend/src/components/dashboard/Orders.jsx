...
const Orders = () => {
  ...
  return (
    <div className="bg-slate-100  rounded-md">
      <h2 className="text-2xl font-bold mb-4 text-slate-600 uppercase">Orders</h2>
      ...
      <div className="pt-4 shadow">
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-left text-gray-500">
            <thead className="text-xs text-gray-50 uppercase bg-slate-400">
              <tr>
            ...
            <tbody>
              {myOrders.map((o, i) => (
                <tr key={i} className="bg-slate-200 border-b border-white">
