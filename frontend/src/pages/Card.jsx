...
const Card = () => {
  ...
  return (
    <div>
      <Headers />
      <PageHeader title="ECOMREZ-SHOP NOW" category="Card" />
      <section className="bg-[#eeeeee]">
        <div className="w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16">
          {card_products.length > 0 || outofstock_products.length > 0 ? (
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                ...
                                <button
                                  ...
                                  className="px-5 py-[3px] bg-amber-500 text-white"
                                >
                                  Delete
                                </button>
                              </div>
            ...
            <div>
              <Link className="px-4 py-1 bg-orange-500 text-white" to="/shops">
                Shop Now
              </Link>
            </div>
          )}
