...
const Shops = () => {
  ...
  }, [state.values[0], state.values[1], category, rating, pageNumber, sortPrice, sortByDate, InStock]);
        ...
        <div className="w-[85%] md:w-[90%%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          ...
          <div className="w-full flex flex-wrap">
            ...
            >
              ...
              <div className="my-3 bg-white p-3 flex flex-col gap-3 justify-center ">
