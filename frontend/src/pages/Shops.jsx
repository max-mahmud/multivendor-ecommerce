...
const Shops = () => {
    ...
    return (
      <div>
        <Headers />
        <section className="h-[180px] mt-6 bg-cover bg-no-repeat relative bg-left">
          <div className="absolute left-0 top-0 w-full h-full bg-[#f8f7f7]">
            ...
            <div className="w-full flex flex-wrap">
              ...
              >
                <div className="py-2 bg-white px-2">
                  ...
                  {categorys.map((c, i) => (
                    <div className="flex justify-start items-center gap-2 pt-[6px]" key={i}>
                ...
                <div className="p-2 px-3 flex flex-col gap-5 bg-white my-2">
                  ...
                  <Range
                    ...
                    renderTrack={({ props, children }) => (
                      <div {...props} className="w-full h-[6px] bg-slate-300 rounded-full cursor-default">
                        {children}
                      </div>
                    )}
                    renderThumb={({ props }) => (
                      <div className="w-[15px] h-[15px] bg-orange-500 rounded" {...props} />
                    )}
                  />
                  <div>
                ...
                <div className="py-3 flex flex-col gap-4 bg-white px-2">
