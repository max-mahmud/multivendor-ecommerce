          ...
          <div className="w-[85%] md:w-[90%%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            ...
            <div className="w-full flex flex-wrap">
              ...
              >
                ...
                <div className="p-2 flex flex-col gap-5 bg-white my-2">
                ...
                <div className="p-2 flex flex-col gap-4 md:hidden bg-white my-2">
                  <h3 className="text-xl font-bold text-slate-600">Product Tag</h3>
                  <div className="flex flex-wrap gap-3">
                    {[1, 2, 3, 4, 5, 6, 7].map((item, i) => (
                      <span key={i} className="bg-slate-200 px-4 py-1">
                        Laptop
                      </span>
                    ))}
                  </div>
