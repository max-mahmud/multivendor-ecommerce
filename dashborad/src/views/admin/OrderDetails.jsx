    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4  bg-slate-100 rounded-md">
        <div className="flex justify-between items-center p-4">
          <h2 className="text-xl text-slate-600">Order Details</h2>
          <select
            name=""
            id=""
            className="px-4 py-2 focus:border-green-500 outline-none bg-slate-100 border border-slate-700 rounded-md text-slate-600"
          >
            ...
            <div className="w-[32%]">
              <div className="pr-3 text-slate-600 text-lg">
                <div className="flex flex-col gap-1">
                  <h2 className="pb-2 font-semibold">Deliver to : Jakir Hasan</h2>
                  <p>
                    <span className="text-sm">Rangpur , kurigran nageshawri house no #54545</span>
                  </p>
                </div>
