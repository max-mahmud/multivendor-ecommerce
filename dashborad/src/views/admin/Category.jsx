          ...
          <div className="w-full pl-5">
            <div className="bg-gray-800 h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
              ...
              <form>
                ...
                <div>
                  <label
                    className="flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-green-500 w-full border-[#d0d2d6]"
                    htmlFor="image"
                  >
                    <span>
                      <BsImage />
                ...
                <div>
                  <button className="bg-green-500 w-full hover:shadow-green-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 my-2 ">
                    Add Category
                  </button>
                </div>
              </form>
